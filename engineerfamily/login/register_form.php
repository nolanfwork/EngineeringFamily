...
<head>
	...
	<title>Register | Engineering Family</title>
...
<?php include '../family/nav.php'; ?> 
	...
	<div class="container mybg">
		<div class="row">
		<h1 class="col-12 mt-4 mb-4 header">Welcome to Engineering Family!</h1>
		</div> <!-- .row -->
	</div> <!-- .container -->
		...
		<form action="register_confirmation.php" method="POST">
			...
			<div class="form-group row">
				...
				<div class="col-sm-9 mt-3">
					...
					<a href="../family" role="button" class="btn btn-light">Cancel</a>
				</div>
			</div> <!-- .form-group -->
